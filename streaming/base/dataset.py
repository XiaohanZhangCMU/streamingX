    ...
    * How to iterate:
    ...
    def on_exception(self, future: Future) -> None:
        ...
        if exception:
            ...
            if my_resource_tracker._fd is not None and  my_resource_tracker._check_alive():
                #if my_resource_tracker._pid is not None and :
                my_resource_tracker._stop()
            else:
                logger.warning(f"xiaohan inside on exception skip stop: {my_resource_tracker._pid}, {my_resource_tracker._fd}, {my_resource_tracker._check_alive()}")
